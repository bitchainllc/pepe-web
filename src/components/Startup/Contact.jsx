                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="form-group mb-20">
                      <input type="text" name="name" className="form-control" placeholder={rtl ? "الأسم" : "Name"} />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="form-group mb-20">
                      <input type="text" name="email" className="form-control" placeholder={rtl ? "البريد الألكترونى *" : "Email Address *"} />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="form-group mb-20">
                      <input type="text" name="phone" className="form-control" placeholder={rtl ? "الهاتف (اختياري)" : "Phone Number (option)"} />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="form-group mb-20">
                      <input type="text" name="website" className="form-control" placeholder={rtl ? "موقعك الالكترونى (اختياري)" : "Your Website (option)"} />
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <div className="form-group mb-20">
                      <select className="form-select" defaultValue={rtl ? "كيف يمكننا مساعدتك?" : "How can we help you?"} name="option">
                  ...
                  <div className="col-lg-12">
                    <div className="form-group">
                      <textarea name="message" rows="10" className="form-control" placeholder={rtl ? "كيف يمكننا مساعدتك?" : "How can we help you?"}></textarea>
                    </div>
                  </div>
