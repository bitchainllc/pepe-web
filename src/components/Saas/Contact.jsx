                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="form-group mb-20">
                      <input type="text" name="name" className="form-control" placeholder={ rtl ? 'الاسم' : "Name" } />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="form-group mb-20">
                      <input type="text" name="phone" className="form-control" placeholder={ rtl ? 'البريد الالكترونى *' : "Email Address *" } />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="form-group mb-20">
                      <input type="text" name="phone" className="form-control" placeholder={ rtl ? 'رقم الهاتف (اختيارى)' : "Phone Number (option)" } />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="form-group mb-20">
                      <input type="text" name="website" className="form-control" placeholder={ rtl ? 'موقعك الالكترونى (اختيارى)' : "Your Website (option)" } />
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <div className="form-group mb-20">
                      <select className="form-select" name="option" defaultValue={ rtl ? 'كيف يمكننا مساعدتك ؟ ' : 'How can we help you?' }>
                  ...
                  <div className="col-lg-12">
                    <div className="form-group">
                      <textarea rows="10" className="form-control" name="message" placeholder={ rtl ? 'كيف يمكننا مساعدتك ؟ ' : 'How can we help you?' }></textarea>
                    </div>
                  </div>
