      ...
      <div className="container">
        <div className="section-head text-center style-4">
          ...
          <h2 className="mb-30">
            ...
            <span> {rtl ? "سعر مناسب" : "Affordable Price"} </span>{" "}
          </h2>
        </div>
        <div className="content">
          <div className="toggle_switch d-flex align-items-center justify-content-center mb-40">
            <div className="form-check form-switch p-0">
              ...
              >
                <small>{rtl ? "تدفع شهريا" : "Billed monthly"}</small>
              </label>
              <input
              ...
              <label
                ...
                htmlFor="flexSwitchCheckDefault"
              >
                <small>{rtl ? "دفع سنوى" : "Billed annually"}</small>
              </label>
            </div>
          </div>
              ...
              <div className="col-lg-6" key={index}>
                <div className="price-card">
                  <div className="price-header pb-4">
                    <h6>
                      {" "}
                      <img src={plan.image} alt="" className="icon" />{" "}
                      {plan.title}{" "}
                    </h6>
                    <h2>
                      {plan.price} <small> / {rtl ? "شهري" : "month"}</small>
                    </h2>
                    ...
                    <Link href="/page-contact-5">
                      <a
                        className={`btn rounded-pill ${
                          index === 0 ? "border-blue4" : "bg-blue4"
                        } hover-blue4 fw-bold mt-50 px-5 ${
                          index === 0 ? "border-blue4" : "text-white"
                        }`}
                      >
